...
const SizePage = () => {
  ...
  const filteredAndSortedSizes = sizes
    ...
    .sort((a, b) => {
      const aValue = a[sortBy.value as keyof Size];
      const bValue = b[sortBy.value as keyof Size];
  ...
  const currentItems = filteredAndSortedSizes.slice(
    indexOfFirstItem,
    indexOfLastItem
  );
  const totalPages = Math.ceil(filteredAndSortedSizes.length / itemsPerPage);
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="mt-1 text-white/80 flex items-center text-sm sm:text-base">
                  <Ruler className="w-3 h-3 sm:w-3.5 sm:h-3.5 mr-1.5 inline" />
                  {sizes.length} {sizes.length === 1 ? "talla" : "tallas"} en el
                  catálogo
                </p>
              </div>
            </div>
              ...
              <div className="divide-y divide-gray-100 dark:divide-gray-700">
                {currentItems.length > 0 ? (
                  ...
                  <div className="flex flex-col items-center justify-center py-12 text-center px-4">
                    <Ruler className="h-12 w-12 text-gray-300 dark:text-gray-600 mb-3" />
                    ...
                    <p className="text-sm mb-4 text-gray-500 dark:text-gray-400">
                      {searchTerm
                        ...
                        : "Comienza creando una nueva talla"}
                    </p>
                    <div className="mt-6">
                      {searchTerm ? (
                        <button
              ...
              {totalPages > 1 && (
                <div className="bg-gray-50 dark:bg-gray-800/50 p-4 border-t border-gray-200 dark:border-gray-700 flex flex-col sm:flex-row justify-between items-center gap-4">
                  ...
                  <div className="text-sm text-gray-500 dark:text-gray-400">
                    ...
                    {Math.min(indexOfLastItem, filteredAndSortedSizes.length)}{" "}
                    de {filteredAndSortedSizes.length} tallas
                  </div>
            ...
            <div className="p-6">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-xl font-bold text-gray-900 dark:text-white">
                  {editId !== null ? "Editar Talla" : "Nueva Talla"}
                </h3>
                <button
                  onClick={closeModal}
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-6">
                {editId !== null
                  ...
                  : "Ingresa el nombre de la nueva talla para tu catálogo"}
              </p>
                  ...
                  <input
                    {...register("name", {
                      ...
                      minLength: {
                        value: 1,
                        message:
                          "El nombre de la talla debe tener al menos 1 caracter",
                      },
                      maxLength: {
                        value: 10,
                        message:
                          "El nombre de la talla no puede exceder los 10 caracteres",
                      },
                      pattern: {
