...
const BrandPage = () => {
  ...
  const handleDelete = async (brand: DataForm) => {
    const confirmed = await AlertHelper.confirm({
      title: "¿Estás seguro?",
      message: `Eliminarás la marca "${brand.name}". Esta acción no se puede deshacer.`,
    ...
    try {
      ...
      if (response) {
        ...
        AlertHelper.success({
          title: "Eliminado",
          message: `La marca "${brand.name}" ha sido eliminada.`,
          timer: 3000,
          animation: "slideIn",
        });
      } else {
      ...
      AlertHelper.error({
        ...
        message:
          ...
          "Ha ocurrido un error al eliminar la marca",
        isModal: true,
        animation: "bounce",
      });
    }
  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-900 min-h-screen">
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="mt-1 text-white/80 flex items-center text-sm sm:text-base">
                  ...
                  {items.length} {items.length === 1 ? "marca" : "marcas"} en el
                  catálogo
                </p>
              </div>
            </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-4 sm:p-6">
        {/* Toolbar - Siguiendo el estilo de productos */}
              ...
              {totalPages > 1 && (
                <div className="bg-gray-50 dark:bg-gray-800/50 p-4 border-t border-gray-200 dark:border-gray-700 flex flex-col sm:flex-row justify-between items-center gap-4">
                  ...
                  <div className="text-sm text-gray-500 dark:text-gray-400">
                    ...
                    de {filteredAndSortedItems.length} marcas
                  </div>
      ...
      {/* Modal - Siguiendo el estilo del componente OrderDetails */}
      {showStatusModal && (
            ...
            <div className="p-6">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-xl font-bold text-gray-900 dark:text-white">
                  {editId !== null ? "Editar Marca" : "Nueva Marca"}
                </h3>
                <button
                  onClick={closeModal}
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-6">
                {editId !== null
                  ...
                  : "Ingresa el nombre de la nueva marca para tu catálogo"}
              </p>
