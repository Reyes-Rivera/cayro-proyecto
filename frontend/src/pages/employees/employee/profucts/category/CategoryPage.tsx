              ...
              <div className="flex items-start gap-3 sm:gap-5">
                ...
                <div>
                  ...
                  <p className="text-sm sm:text-base text-gray-600 dark:text-gray-300 mt-1 sm:mt-2 max-w-2xl">
                    ...
                    Las categorías son esenciales para organizar y filtrar tus
                    productos.
                  </p>
                </div>
              </div>
              ...
              {currentItems.length > 0 ? (
                ...
                >
                  <div className="bg-blue-50 dark:bg-blue-900/20 p-4 sm:p-6 rounded-full mb-4">
                    <Tag className="w-8 h-8 sm:w-12 sm:h-12 text-blue-400 dark:text-blue-300" />
                  </div>
                  ...
                  <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mb-4 sm:mb-6 max-w-md">
                    {searchTerm
                      ? "Intenta con otro término de búsqueda o limpia los filtros para ver todas las categorías"
                      : "Añade categorías para comenzar a gestionar tu catálogo de productos"}
                  </p>
                  {searchTerm ? (
                    <motion.button
                      whileHover={{ scale: 1.05 }}
          ...
          >
            <div className="flex items-center justify-center min-h-screen px-4">
              ...
              >
                {/* Decorative elements */}
                <div className="absolute top-0 right-0 w-24 sm:w-32 h-24 sm:h-32 bg-gradient-to-br from-blue-500/10 to-blue-700/10 rounded-full -mr-12 sm:-mr-16 -mt-12 sm:-mt-16 dark:from-blue-500/20 dark:to-blue-700/20"></div>
                <div className="absolute bottom-0 left-0 w-16 sm:w-24 h-16 sm:h-32 bg-gradient-to-tr from-blue-400/10 to-blue-600/10 rounded-full -ml-8 sm:-ml-12 -mb-8 sm:-mb-12 dark:from-blue-400/20 dark:to-blue-600/20"></div>
