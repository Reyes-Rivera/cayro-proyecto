      ...
      <div className="flex flex-grow">
        <div className="w-full lg:w-1/2 flex items-center justify-center p-10">
          <div className="w-full max-w-md space-y-6 bg-white dark:bg-gray-800 dark:text-gray-100 p-8 rounded-xl shadow-lg">
            <div className="text-center">
              <h2 className="text-3xl font-bold text-gray-900 dark:text-gray-100">Crea tu cuenta en Cayro</h2>
            </div>
              ...
              <div className="grid grid-cols-2 gap-2">
                <div>
                  ...
                  <Input
                    ...
                    id="nombre"
                    type="text"
                    className="appearance-none rounded-md relative block w-full px-3 py-2 border border-gray-300 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-[#0099FF] focus:border-[#0099FF] focus:z-10 sm:text-sm mt-1"
                    placeholder="nombre"
                  />
              ...
              <div>
                ...
                <div className="relative">
                  <Input
                    ...
                    autoComplete="new-password"
                    className={`appearance-none rounded-md relative block w-full px-3 py-2 border placeholder-gray-500 text-gray-900 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100 focus:outline-none focus:ring-[#0099FF] focus:z-10 sm:text-sm mt-1`}
            ...
            {/* <div className="text-center mt-4">
              <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-2 bg-white dark:bg-gray-800 text-gray-500 dark:text-gray-300">O regístrate con</span>
                </div>
              </div>
        ...
        <div className="hidden w-1/2 lg:flex lg:items-center lg:justify-center">
          <div className="relative h-3/4 w-3/4">
            ...
            <p className="text-3xl font-bold text-gray-900 dark:text-gray-100 text-center mb-4">Únete a Cayro Uniformes</p>
            <p className="text-center text-gray-500 dark:text-gray-300">Crea tu cuenta para acceder a ofertas exclusivas, seguimiento de pedidos y mucho más.</p>
          </div>
        </div>
      </div>
    </div>
