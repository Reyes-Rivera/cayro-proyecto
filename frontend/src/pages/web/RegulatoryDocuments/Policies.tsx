            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                >
                  ...
                  Este aviso describe cómo recopilamos, usamos y compartimos tus
                  datos cuando interactúas con nuestros servicios.
                </motion.p>
              ...
              >
                ...
                <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white p-8 relative z-10">
                  ...
                  <p className="mt-4 text-blue-50 max-w-3xl">
                    ...
                    compartimos tu información personal cuando visitas o
                    realizas una compra en nuestro sitio.
                  </p>
                </div>
                  ...
                  {isLoading ? (
                        ...
                        <div className="flex items-start">
                          ...
                          <div>
                            ...
                            <p className="text-gray-700 dark:text-gray-300">
                              Este documento explica cómo recopilamos,
                              utilizamos y protegemos tu información personal.
                              Te recomendamos leerlo detenidamente para entender
                    ...
                    <div className="flex flex-col items-center justify-center py-16 text-center">
                      ...
                      <p className="text-gray-600 dark:text-gray-400 max-w-md">
                        En este momento no podemos mostrar el aviso de
                        privacidad. Por favor, intenta nuevamente más tarde.
                      </p>
                    </div>
                  )}
                </div>
