        ...
        <div className="container mx-auto px-6 py-16 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              >
                Conoce cómo protegemos y tratamos tu información personal. Este
                aviso describe cómo recopilamos, usamos y compartimos tus datos
            ...
            >
              ...
              <motion.div
                ...
                className="relative z-20 rounded-2xl overflow-hidden shadow-2xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700"
              >
                <div className="p-8">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-gray-100 dark:bg-gray-700/50 rounded-lg p-3">
                      <div className="flex items-center text-gray-700 dark:text-gray-300 text-sm mb-1">
                        <FileText className="w-4 h-4 mr-2 text-blue-600 dark:text-blue-400" />
                        <span className="font-medium">Uso de información</span>
                      </div>
                    ...
                    <div className="bg-gray-100 dark:bg-gray-700/50 rounded-lg p-3">
                      <div className="flex items-center text-gray-700 dark:text-gray-300 text-sm mb-1">
                        <FileText className="w-4 h-4 mr-2 text-blue-600 dark:text-blue-400" />
                        <span className="font-medium">Derechos ARCO</span>
                      </div>
                      <div className="h-2 w-1/2 bg-gray-200 dark:bg-gray-600 rounded-full mb-2"></div>
                      <div className="h-2 w-3/4 bg-gray-200 dark:bg-gray-600 rounded-full mb-2"></div>
                      <div className="h-2 w-2/3 bg-gray-200 dark:bg-gray-600 rounded-full"></div>
                    </div>

                    <div className="bg-blue-600 text-white text-center py-2 rounded-lg font-medium flex items-center justify-center">
              ...
              <motion.div
                ...
                animate={{ opacity: 0.7, x: 15, y: 15 }}
                transition={{ duration: 0.5, delay: 0.6 }}
                className="absolute top-4 -right-4 w-full h-full bg-gray-200 dark:bg-gray-700 rounded-2xl -z-10"
              ></motion.div>
              <motion.div
                initial={{ opacity: 0, x: 20, y: 20 }}
                animate={{ opacity: 0.5, x: 30, y: 30 }}
                transition={{ duration: 0.5, delay: 0.7 }}
                className="absolute top-4 -right-4 w-full h-full bg-gray-100 dark:bg-gray-600 rounded-2xl -z-20"
              ></motion.div>
            </motion.div>
          </div>
        </div>
                      ...
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="text-gray-700 dark:text-gray-300">
                            Este documento explica cómo recopilamos, utilizamos
                            y protegemos tu información personal. Te
                            recomendamos leerlo detenidamente para entender
                            nuestras prácticas respecto a tus datos.
                          </p>
                        </div>
                      </div>
                    </motion.div>
                  ...
                  <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
                    ...
                    <div className="flex items-center">
                      ...
                      <span className="text-sm text-gray-700 dark:text-gray-300">
                        Este documento es de carácter informativo y cumple con
