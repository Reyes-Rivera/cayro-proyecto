            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                >
                  ...
                  productos. Este documento establece los términos bajo los
                  cuales ofrecemos nuestros servicios.
                </motion.p>
                        ...
                        <div className="flex items-start">
                          ...
                          <div>
                            ...
                            <p className="text-gray-700 dark:text-gray-300">
                              Este documento establece los términos y
                              condiciones que rigen el uso de nuestros productos
                              y servicios. Te recomendamos leerlo detenidamente
                              antes de utilizar nuestro sitio web o realizar
                              cualquier compra.
                            </p>
                          </div>
                        </div>
