...
export default function Terms() {
  ...
  const scrollToContent = () => {
    const contentSection = document.getElementById("terms-content");
    if (contentSection) {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              >
                ...
                >
                  <Book className="w-4 h-4 mr-2 text-blue-600 dark:text-blue-400" />
              ...
              >
                ...
                productos. Este documento establece los términos bajo los cuales
            ...
            >
              ...
              <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white p-8 relative z-10">
                ...
                <p className="mt-4 text-blue-50 max-w-3xl">
                  ...
                  acceder o utilizar nuestro sitio web, aceptas estos términos
                  en su totalidad.
                </p>
              </div>
                      ...
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="text-gray-700 dark:text-gray-300">
                            ...
                            que rigen el uso de nuestros productos y servicios.
                            Te recomendamos leerlo detenidamente antes de
                            utilizar nuestro sitio web o realizar cualquier
                            compra.
                          </p>
                        </div>
                      </div>
