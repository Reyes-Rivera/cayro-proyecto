            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4 mt-4">
                <p className="text-gray-600">
                  Mantén el estilo y la comodidad con esta sudadera con capucha
                  de color negro, diseñada para transmitir buenas vibras.
                  Presenta un estampado retro con la frase &apos;Good Vibes&apos; en
                  colores vibrantes que destacan sobre el fondo oscuro.
                </p>
                <p className="text-gray-600">
                  Mezcla de algodón suave y duradera para mayor confort, ajuste
                  regular con bolsillo tipo canguro y cordones en la capucha.
                </p>
              </div>
            </div>
          </div>
