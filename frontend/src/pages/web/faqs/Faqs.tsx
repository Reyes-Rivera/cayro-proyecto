          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              >
                ...
                >
                  {title}{" "}
                  <span className="text-blue-600">que necesitas saber</span>
                </motion.h1>
              </motion.div>
            ...
            >
              ...
              <motion.div
                ...
                className="relative z-20 rounded-2xl overflow-hidden shadow-2xl bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700"
              >
                <div className="p-8">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-gray-100 dark:bg-gray-700/50 rounded-lg p-3">
                      ...
                      <div className="h-2 w-1/2 bg-gray-200 dark:bg-gray-600 rounded-full"></div>
                    </div>
