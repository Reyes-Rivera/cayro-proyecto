...
import CartRecommendationsCarousel from "./components/CartRecommendations";
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <div className="space-y-1 text-sm text-gray-500 dark:text-gray-400 mt-1">
                      <p>• El costo de envío se calculará en el checkout</p>
                      <p>• Basado en tu ubicación y cantidad de productos</p>
                      <p>• Predicción precisa con inteligencia artificial</p>
                    </div>
