...
export default function Sidebar({ isOpen, onClose, onFilterChange, onSearch }: SidebarProps) {
  ...
  return (
    <aside
      className={`fixed top-0 max-h-[800px] right-0 h-full w-80 bg-white shadow-lg transform transition-transform duration-300 ease-in-out z-10 overflow-y-hidden
        ...
        <div className="space-y-6">
          ...
          <div className="border-b border-gray-100 pb-6">
            ...
            <div className="space-y-3">
              {["Uniformes Escolares", "Uniformes Deportivos", "Polos", "Playeras", "Gorras", "Calcetas"].map(
                (category) => (
          ...
          {/* Precio */}
          <Accordion type="single" collapsible className="border-b border-gray-100 pb-6">
            ...
            <AccordionItem value="colores" className="border-none">
              ...
              <AccordionContent>
                <div className="flex flex-wrap gap-3 pt-4">
                  {["#EF4444", "#3B82F6", "#10B981", "#F59E0B", "#8B5CF6", "#111827"].map((color) => (
                    <button
                      key={color}
                      className={`w-8 h-8 rounded-full ring-2 ring-offset-2 transition-all ${
                        filters.colors.includes(color) ? "ring-gray-900" : "ring-transparent hover:ring-gray-300"
                      }`}
