...
const Footer = () => {
    const [socialMedias, setSocialMedias] = useState<Socialdata[]>([]);
    ...
    useEffect(() => {
        const getInfoCompany = async () => {
            ...
            setSocialMedias(res.data[0].socialLinks || []);
        };
        getInfoCompany();
    }, []);
            ...
            <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
                    <div className="text-center md:text-left">
                        ...
                        <p className="text-sm mt-2">{slogan}</p>
                    </div>
                    ...
                    <div className="text-center md:text-right">
                        ...
                        <Link to="/legal" className="block hover:text-white">
                            Deslinde legal
                        </Link>
