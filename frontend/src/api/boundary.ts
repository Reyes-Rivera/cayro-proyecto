...
export const updateBoundaryApi = async (data: object, id: number) => {
  const res = await axios.put(
    `/regulatory-document/update-boundary/${id}`,
    data,
    {
      withCredentials: true,
    }
...
export const deleteBoundaryApi = async (id: number) => {
...
export const activeBoundaryApi = async (id: number) => {
