...
export const updatePolicysApi = async (data: object, id: number) => {
  const res = await axios.put(
    `/regulatory-document/update-policy/${id}`,
    data,
    {
      withCredentials: true,
    }
...
export const deletePolicysApi = async (id: number) => {
...
export const activePolicyApi = async (id: number) => {
